    ...
    if (empty($_SESSION["usuario"])):
        ...
        if (PermissionValidator::isAdministrador()) :
            ...
            if (@$_POST['osso-existente'] == "inserir") {
                ...
                $osso->setQtdDisponivel($qtdDisponivel);
...
<aside>
    ...
    <ul class="sideMenu">
        ...
        <li class="active">
            <a href="osso-cadastrar-existente.php">Osso</a>
        </li>
        <li>
        ...
        <div class="span12">
            <div class="tabbable widget">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="osso-cadastrar-existente.php" data-toggle="tab">Cadastrar Osso Existente</a></li>
